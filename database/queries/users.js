export default {
    ...
    selectFromFirstName: 'SELECT * FROM users WHERE first_name LIKE $1 ORDER BY id LIMIT 10 OFFSET $2;',
    selectFromID: 'SELECT * FROM users WHERE id = $1 LIMIT 1;',
    selectAll: 'SELECT * FROM users ORDER BY id LIMIT 10 OFFSET $1 ;',
